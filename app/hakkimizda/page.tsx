      ...
      <main id="main-content" className="py-12 px-6 relative z-10 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm mb-8">
            {/* Misyonumuz Section */}
            <div className="mb-16">
              <h2 className="text-3xl font-medium mb-8 text-gray-700 text-center">Misyonumuz</h2>
              <p className="text-gray-600 leading-relaxed text-lg mb-8 text-center max-w-4xl mx-auto">
                Skycrops olarak misyonumuz; doğaya ve insana saygılı, en yüksek besin değerine ve tazeliğe sahip yeşillikleri yılın her günü tüketicilerle buluşturmaktır. Türkiye'de geliştirdiğimiz yenilikçi dikey tarım teknolojileri sayesinde suyu, enerjiyi ve alanı verimli kullanarak sürdürülebilir gıda üretimini mümkün kılıyoruz. Amacımız; sağlıklı, pestisitsiz ve güvenilir ürünler sunarken aynı zamanda geleceğin tarım modellerine öncülük etmektir.
              </p>
            </div>

            {/* Vizyonumuz Section */}
            <div className="mb-16">
              <h2 className="text-3xl font-medium mb-8 text-gray-700 text-center">Vizyonumuz</h2>
              <p className="text-gray-600 leading-relaxed text-lg mb-8 text-center max-w-4xl mx-auto">
                Skycrops olarak vizyonumuz; sürdürülebilir tarımda Türkiye'den dünyaya uzanan bir öncü olmak, gıda güvenliğini artıran yenilikçi çözümler üretmek ve geleceğin şehirlerinde sağlıklı yaşamın kaynağı haline gelmektir. Amacımız, dikey tarım teknolojilerini sürekli geliştirerek hem ülkemizde hem de global ölçekte insanlara daha sağlıklı, güvenilir ve erişilebilir ürünler sunmaktır.
              </p>
            </div>

            {/* Neden Dikey Tarım Section */}
            <div className="mb-16">
              <h2 className="text-3xl font-medium mb-12 text-gray-700 text-center">Neden Dikey Tarım</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-medium mb-4 text-gray-700">Ürün Kalitesi</h3>
                  <ul className="text-gray-600 space-y-2 text-left">
                    <li>• <strong>Daha sağlıklı:</strong> Pestisitsiz ve güvenilir üretim</li>
                    <li>• <strong>Daha taze:</strong> Hasat edildiği gün sofrada</li>
                    <li>• <strong>Daha lezzetli:</strong> Yüksek besin değerini korur</li>
                  </ul>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-medium mb-4 text-gray-700">Çevre Dostu</h3>
                  <ul className="text-gray-600 space-y-2 text-left">
                    <li>• <strong>Daha az su tüketimi:</strong> Klasik tarıma göre %90 su tasarrufu</li>
                    <li>• <strong>Daha düşük karbon ayak izi:</strong> Şehir içi üretim ile daha az lojistik ve karbon ayak izi</li>
                  </ul>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-medium mb-4 text-gray-700">Geleceğin Tarımı</h3>
                  <ul className="text-gray-600 space-y-2 text-left">
                    <li>• <strong>Gıda güvenliği:</strong> İklim krizine ve artan nüfusa karşı sürdürülebilir çözüm</li>
                    <li>• <strong>Her zaman, her yerde üretim:</strong> Her mevsim ve her şehirde kontrollü koşullarda yetiştirme</li>
                    <li>• <strong>Yüksek verim & tam izlenebilirlik:</strong> Modern teknolojilerle güvenilir üretim</li>
                  </ul>
                </div>
              </div>
            </div>
