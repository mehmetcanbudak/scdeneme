...
import { ArrowLeft, MapPin, Plus, CreditCard, Truck, Shield, Clock } from "lucide-react"
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center pt-24">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            {authLoading ? 'Kullanıcı bilgileri yükleniyor...' : 'Sipariş bilgileri yükleniyor...'}
          </p>
        </div>
      </div>
    )
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center space-x-4">
              <Link href="/sepet" className="flex items-center text-gray-600 hover:text-gray-800">
                ...
                <div className="p-6">
                  {!showAddressForm ? (
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-gray-600 text-sm">Adres ekleme formu yakında eklenecek...</p>
                      <Button
                        variant="outline"
                ...
                <div className="p-6">
                  <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                    ...
                    <p className="text-sm text-gray-700">
                      ...
                      Kredi kartı, banka kartı veya havale ile ödeme yapabilirsiniz.
                    </p>
                  </div>
                </div>
              </div>
