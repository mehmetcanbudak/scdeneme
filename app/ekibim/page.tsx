    ...
    <div className="min-h-screen bg-white relative">
      ...
      <section className="relative h-[52.5vh] overflow-visible z-10">
        <div className="absolute inset-0">
          <img src="/agricultural-figures-with-plants-and-sun.png" alt="Ekibimiz" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 h-full flex items-center justify-center text-center text-white">
          <div className="max-w-4xl mx-auto px-6">
            <div className="mb-8">
              <h1 className="text-5xl md:text-7xl font-light mb-8 tracking-wide">EKİBİMİZ</h1>
            </div>
          </div>
        </div>
      </section>
      ...
      <main id="main-content" className="py-12 px-6 relative z-10 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-light mb-4 tracking-wide text-gray-800">Ekibimiz</h1>
            <p className="text-lg text-gray-600">Deneyimli ve tutkulu tarım uzmanları</p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  description: "Modern sera teknolojileri ve sürdürülebilir üretim uzmanı",
                },
                {
                  name: "Mehmet Kaya",
                  role: "Kalite Kontrol",
