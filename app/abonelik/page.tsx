...
import { ChevronDown, Leaf, Truck, Shield, Award, Check, Star, Minus, Plus } from "lucide-react"
...
export default function Abonelik() {
  ...
  const [selectedPurchaseOption, setSelectedPurchaseOption] = useState<'subscription' | 'oneTime'>('subscription')
  const [quantity, setQuantity] = useState(1)
  const [selectedDeliveryDay, setSelectedDeliveryDay] = useState<number>(1)
  const [deliveryFrequency, setDeliveryFrequency] = useState<'oneTime' | 'weekly' | 'biweekly'>('weekly')
  ...
  const faqItems = [
    {
      ...
      answer: "Her ürünün büyüme süresi ve verimlilik miktarı farklılık göstermektedir. Örneğin, bazı yeşillikler daha kısa sürede hasada gelirken, bazı çeşitlerin olgunlaşması daha uzun zaman almaktadır. Ayrıca aynı üretim alanından elde edilen demet sayısı da her tür için değişmektedir.\n\nBu sebeplerle paket içeriğini bireysel tercihlere göre belirlemek, üretim planlamasında ciddi operasyonel zorluklar yaratır ve ürünlerin düzenli ve sürdürülebilir şekilde ulaştırılmasını engelleyebilir.\n\nSkycrops olarak biz, bu süreci titizlikle yönetiyor ve paketlerinizi her hafta dengeli, çeşitli ve taptaze ürünlerle hazırlıyoruz. Böylece abonelerimiz hiçbir planlama yapmadan, güvenle sofralarında farklı lezzetleri deneyimleyebiliyor."
    },
    {
      id: "faq-2",
      question: "Ürünler nasıl paketleniyor?",
      answer: "Yeşilliklerimiz kontrollü ve hijyenik koşullarda yetiştirildiği için yıkanmasına gerek kalmaz. Hasat edildiği gün tazeliğini kaybetmeden ayıklanır, özenle paketlenir ve özel ambalajlarla sofranıza ulaşır."
    },
    {
      id: "faq-3",
      question: "Teslimat günümü değiştirebilir miyim?",
      answer: "Teslimatlar belirli günlerde planlanmaktadır. Abonelik başlangıcında size en uygun günü seçebilirsiniz. Sonrasında gün değişikliği ihtiyacınız olursa hesabınızdan değişiklik yapabilirsiniz."
    },
    {
      id: "faq-4",
      question: "Aboneliğimi dondurabilir miyim?",
      answer: "Evet. İstediğinizde ara verebilir, dilediğiniz zaman kaldığınız yerden devam edebilirsiniz."
    },
    {
      id: "faq-5",
      question: "Abonelik planımı değiştirebilir miyim?",
      answer: "Evet. Aboneliğinizi haftalık ya da iki haftada bir olacak şekilde değiştirebilirsiniz. Değişiklik sonrasında planınız hızlıca güncellenir ve teslimatlar yeni planınıza göre devam eder."
    },
    {
      id: "faq-6",
      question: "Tek seferlik satın alma yapabiliyor muyum?",
      answer: "Evet. Abonelik dışında tek seferlik satın alma da yapabilirsiniz. Böylece ürünlerimizi denemek isterseniz önce tek kutu sipariş verebilir, sonrasında dilerseniz aboneliğe geçebilirsiniz. Düzenli tazelik isteyenler için abonelik öneriyoruz; ancak tek seferlik siparişlerle de Skycrops lezzetini deneyimlemeniz mümkün."
    },
    {
      id: "faq-7",
      question: "Ürünler kargoda zarar görürse ne yapılır?",
      answer: "Nadiren de olsa taşıma sırasında ürünlerde zarar oluşabilir. Böyle bir durumda hemen bizimle iletişime geçmenizi rica ederiz. Fotoğraf paylaşmanızın ardından size en kısa sürede yeni ürün gönderimi yapılır."
    },
    {
      id: "faq-8",
      question: "Neden Skycrops ürünlerine güvenmeliyim?",
      answer: "Skycrops olarak tüm ürünlerimizi kontrollü, kapalı ve hijyenik koşullarda, pestisit kullanılmadan üretiyoruz. Üretimimiz, resmi olarak aldığımız İyi Tarım Uygulamaları Belgesi ile de tescillenmiş durumda.\n\nBu belge, gıda güvenliği, çevreye duyarlılık ve sürdürülebilirlik kriterlerine uygun üretim yaptığımızı kanıtlar. Yani sofranıza gelen her yeşillik, hem sağlıklı hem de güvenilir bir şekilde yetiştirilmiştir."
    }
  ]
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
                Skycrops abonelik sistemiyle tanışın: Şehirde yaşarken en taze, en lezzetli ve en sağlıklı yeşilliklere zahmetsizce ulaşmanın en kolay yolu.
              </p>
              <div className="mt-8">
                <Button
                  onClick={() => router.push("/abonelik/taze-yesillikler-paketi")}
                  className="bg-gray-600 hover:bg-gray-700 text-white px-10 py-4 text-lg rounded-lg font-medium shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
                >
                  Hemen Abone Ol
                </Button>
              </div>
              ...
              <div className="space-y-12">
                ...
                <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-100">
                  <div className="flex items-start space-x-4 mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-medium text-gray-800 mb-3">Her hafta farklı çeşitler</h3>
                ...
                <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-100">
                  <div className="flex items-start space-x-4 mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-medium text-gray-800 mb-3">Abone olun, gerisini bize bırakın</h3>
                      <p className="text-gray-600 leading-relaxed">
                ...
                <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-100">
                  <div className="flex items-start space-x-4 mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-medium text-gray-800 mb-3">Doğal ve güvenilir üretim</h3>
                      <p className="text-gray-600 leading-relaxed">
                ...
                <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-100">
                  <div className="flex items-start space-x-4 mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-medium text-gray-800 mb-3">Daha taze, daha pratik</h3>
                      <p className="text-gray-600 leading-relaxed">
              ...
              <div className="lg:sticky lg:top-8">
                <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-100">
                  <div className="text-center mb-8">
                    ...
                    <h3 className="text-3xl font-medium text-gray-800 mb-4">Örnek Haftalık Programlar</h3>
                    <p className="text-gray-600 leading-relaxed">
                      Aboneliğinizle birlikte her hafta sofranıza farklı kombinasyonlarda 8 adet taptaze yeşillik gelir.
                    </p>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-gray-50 rounded-lg p-6">
                      <h4 className="font-medium text-gray-800 mb-3 flex items-center">
                        <span className="w-8 h-8 bg-gray-600 text-white rounded-full flex items-center justify-center text-sm font-medium mr-3">1</span>
                        Örnek Hafta
                      </h4>
                    ...
                    <div className="bg-gray-50 rounded-lg p-6">
                      <h4 className="font-medium text-gray-800 mb-3 flex items-center">
                        <span className="w-8 h-8 bg-gray-600 text-white rounded-full flex items-center justify-center text-sm font-medium mr-3">2</span>
                        Örnek Hafta
                      </h4>
                      <p className="text-sm text-gray-600 leading-relaxed">
                    ...
                    <div className="bg-gray-50 rounded-lg p-6">
                      <h4 className="font-medium text-gray-800 mb-3 flex items-center">
                        <span className="w-8 h-8 bg-gray-600 text-white rounded-full flex items-center justify-center text-sm font-medium mr-3">3</span>
                        Örnek Hafta
                      </h4>
                      <p className="text-sm text-gray-600 leading-relaxed">
                    ...
                    <div className="bg-gray-50 rounded-lg p-6">
                      <h4 className="font-medium text-gray-800 mb-3 flex items-center">
                        <span className="w-8 h-8 bg-gray-600 text-white rounded-full flex items-center justify-center text-sm font-medium mr-3">4</span>
                        Örnek Hafta
                      </h4>
                      <p className="text-sm text-gray-600 leading-relaxed">
                  ...
                  <div className="mt-8 text-center">
                    <Button
                      onClick={() => router.push("/abonelik/taze-yesillikler-paketi")}
                      className="bg-gray-600 hover:bg-gray-700 text-white px-8 py-3 rounded-lg font-medium shadow-sm hover:shadow-md transition-all duration-300 w-full"
                    >
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`flex-shrink-0 w-20 h-20 bg-gray-50 rounded-lg overflow-hidden border-2 transition-colors cursor-pointer ${
                        selectedImage === index ? 'border-gray-600' : 'border-gray-200 hover:border-gray-400'
                      }`}
                    >
                      <img
                        src={img}
              ...
              <div className="space-y-6">
                    ...
                    >
                      <div className="flex items-center justify-between mb-3">
                        <div>
                          ...
                          <div className="text-sm text-gray-600">Düzenli teslimat ile %35 tasarruf et</div>
                        </div>
                      ...
                      <div className="space-y-3 mt-3 pt-3 border-t border-gray-200">
                        ...
                        <div>
                          <select 
                            ...
                            onChange={(e) => setDeliveryFrequency(e.target.value as 'oneTime' | 'weekly' | 'biweekly')}
                        ...
                        <div className="bg-gray-50 p-3 rounded text-sm">
                          <p className="text-gray-700">
                            <strong>{quantity} adet</strong> ürün, <strong>
                              {deliveryFrequency === 'weekly' ? 'her hafta' : 
                               deliveryFrequency === 'biweekly' ? '2 haftada bir' : 'tek seferlik'}
                            </strong> <strong>{deliveryDays.find(d => d.id === selectedDeliveryDay)?.name}</strong> günleri teslimat edilecek.
                          </p>
                        </div>
                      </div>
                    )}
                ...
                <Button
                  onClick={() => router.push("/abonelik/taze-yesillikler-paketi")}
                  className="w-full bg-gray-600 hover:bg-gray-700 text-white py-4 text-lg font-medium rounded-xl transition-all duration-300"
                >
                  Sepete Ekle
                </Button>
