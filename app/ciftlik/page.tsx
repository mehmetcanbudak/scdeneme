      ...
      <main id="main-content" className="py-12 px-6 relative z-10 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-light mb-4 tracking-wide text-gray-800">Çiftliğimiz</h1>
            <p className="text-lg text-gray-600">Modern teknoloji ile sürdürülebilir tarım</p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm mb-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-light mb-6 text-gray-700">Sürdürülebilir Tarım</h2>
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Modern sera teknolojisi ile doğal yöntemleri harmanlayarak, en taze ve sağlıklı sebzeleri
                  yetiştiriyoruz. Çevre dostu üretim yöntemlerimiz ile hem doğayı koruyor hem de size en kaliteli ürünleri
                  sunuyoruz.
                </p>
