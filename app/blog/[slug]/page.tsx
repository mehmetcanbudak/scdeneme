...
import { ShoppingBag, User, Search, Calendar, ArrowLeft, Clock } from "lucide-react"
    ...
    <div className="min-h-screen bg-white relative">
      ...
      <header className="bg-white shadow-sm relative z-10">
        <nav className="flex items-center justify-between px-6 py-4">
          <div className="flex items-center space-x-8">
            <Link href="/" className="text-2xl font-light tracking-wider text-gray-700">
              skycrops
            </Link>
            <div className="hidden md:flex space-x-6 text-sm uppercase tracking-wide">
              <Link href="/hakkimizda" className="hover:opacity-70 transition-colors text-gray-600">
                HAKKIMIZDA
              </Link>
                              <Link href="/abonelik" className="hover:opacity-70 transition-colors text-gray-600">
                  ÜRÜNLER
                </Link>
                <Link href="/abonelik" className="hover:opacity-70 transition-colors text-gray-600">
                  ABONELİK
                </Link>
                              <Link href="/tesisler" className="hover:opacity-70 transition-colors text-gray-600">
                  TESİSLER
                </Link>
              <Link href="/blog" className="hover:opacity-70 transition-colors text-gray-800 font-medium">
                BLOG
              </Link>
              <Link href="/iletisim" className="hover:opacity-70 transition-colors text-gray-600">
                İLETİŞİM
              </Link>
            </div>
          </div>
      ...
      <main className="py-12 px-6 relative z-10">
        <div className="max-w-4xl mx-auto">
          {/* Back to Blog */}
          <div className="mb-8">
            <Link href="/blog" className="inline-flex items-center text-gray-600 hover:text-gray-800 transition-colors">
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm mb-8">
            ...
            <h1 className="text-3xl md:text-4xl font-medium mb-6 text-gray-800 leading-tight">{article.title}</h1>

            <p className="text-lg text-gray-600 leading-relaxed mb-8">{article.excerpt}</p>
          </div>
