...
export default function Blog() {
	...
	return (
		<div className="min-h-screen bg-white relative">
			...
			<main
				id="main-content"
				className="py-12 px-6 relative z-10 bg-[#76A4CE]/[0.34]"
			>
				<div className="mx-12">
					{/* Page Header */}
					...
					{/* Featured Post */}
					<div className="bg-green-50 p-8 rounded-lg shadow-sm mb-8">
						<p className="text-sm uppercase tracking-widest text-gray-600 mb-6">
							Son Makale
						</p>
						<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
							...
							<div>
								...
								<h2 className="text-2xl font-medium mb-4 text-gray-700 leading-tight">
									{blogPosts[0].title}
								</h2>
