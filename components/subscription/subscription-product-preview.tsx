 ...
 */
const SubscriptionProductPreview: React.FC<SubscriptionProductPreviewProps> =
	memo(
		({
			product,
			loading,
			...
			const [selectedInterval, setSelectedInterval] =
				useState<SubscriptionInterval | null>(
				...
				<div className="grid lg:grid-cols-2 gap-16 items-start">
					...
					<div className="space-y-6">
						...
						<div className="space-y-3">
							{/* Subscription Option */}
							<div
								className={`p-4 rounded-3xl border border-black transition-all duration-300 hover:shadow-md ${
													...
													return (
														<div key={day.id} className="flex flex-col">
															<button
																type="button"
																onClick={() =>
																	!isInactive && setSelectedDeliveryDay(day.id)
																}
																disabled={isInactive}
