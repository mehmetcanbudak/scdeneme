  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
      ...
      <div className="p-8">
        ...
        {/* Features */}
        <div className="mb-8">
          <h4 className="font-medium text-gray-700 mb-4">Abonelik Avantajları:</h4>
        ...
        <div className="flex items-center justify-between mb-8 bg-gray-50 rounded-lg p-6 border border-gray-200">
          <div className="flex items-center space-x-4">
            <span className="text-4xl font-bold text-gray-800">{discountedPrice}₺</span>
            <span className="text-xl text-gray-500 line-through">{originalPrice}₺</span>
          </div>
          <div className="text-right">
            <div className="text-sm text-gray-600">Aylık</div>
            <div className="text-lg font-semibold text-red-600">%33 İndirim</div>
          </div>
        </div>
        ...
        <Button
          ...
          className="w-full bg-gray-600 hover:bg-gray-700 text-white py-4 text-lg rounded-lg font-medium transition-all duration-300 shadow-sm hover:shadow-md"
        >
          ABONE OL
        </Button>
      </div>
...
export const TestimonialCard = memo(function TestimonialCard({
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
      ...
      <p className="text-gray-600 mb-6 italic leading-relaxed text-sm">"{comment}"</p>
    ...
    <section className={`py-20 px-6 bg-gray-50 ${className}`}>
      <div className="max-w-4xl mx-auto text-center">
        <div className="bg-white p-12 rounded-lg shadow-sm border border-gray-100">
          ...
          <Button 
            onClick={onButtonClick}
            className="bg-gray-600 hover:bg-gray-700 text-white px-8 py-4 text-lg rounded-lg font-medium transition-all duration-300 shadow-sm hover:shadow-md"
          >
            {buttonText}
          </Button>
        </div>
