...
export default function OTPLoginForm({ onSuccess, onCancel }: OTPLoginFormProps) {
  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader className="text-center">
        ...
        <CardDescription>
          <span className="font-medium">{formatPhone(phone)}</span> numarasına gönderilen 6 haneli kodu girin
        </CardDescription>
      </CardHeader>
      <CardContent>
