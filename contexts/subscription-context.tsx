...
export function SubscriptionProvider({ children }: { children: ReactNode }) {
	...
	const loadSubscriptions = async (): Promise<void> => {
		try {
			...
			const errorMessage =
				err instanceof Error ? err.message : "Abonelikler yüklenemedi";
			setError(errorMessage);
	...
	const createSubscription = async (data: {
		...
		try {
			...
			const errorMessage =
				err instanceof Error ? err.message : "Abonelik oluşturulamadı";
			setError(errorMessage);
	...
	const cancelSubscription = async (
		...
		try {
			...
			const errorMessage =
				err instanceof Error ? err.message : "Abonelik iptal edilemedi";
			setError(errorMessage);
			return { success: false, message: errorMessage };
		} finally {
			setIsLoading(false);
	...
	const retryPayment = async (
		...
		try {
			...
			const errorMessage =
				err instanceof Error ? err.message : "Ödeme tekrar denenemedi";
			setError(errorMessage);
			return { success: false, message: errorMessage };
		} finally {
			setIsLoading(false);
