...
export const FOOTER_SECTIONS: FooterSection[] = [
	{
		...
		links: [
			...
			{
				href: "/abonelik/taze-yesillikler-paketi",
				label: "Taze Yeşillikler Paketi",
			},
		],
	},
	{
		...
		links: [
			{
				...
				label:
					"Çorlu 1 OSB, Bülent Ecevit Caddesi No:13/1, PK: 59860 – Tekirdağ, Türkiye",
				external: true,
...
export const FOOTER_POLICY_LINKS = [
	...
	{
		href: "/kalite-gida-guvenligi-politikasi",
		label: "Kalite ve Gıda Güvenliği Politikası",
	},
];
